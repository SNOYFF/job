var city = new Vue({
	...
	data:{
		...
		jobname8:[],
		nums8:[],
		title:"<span class='glyphicon glyphicon-stats' ></span> 全国大数据薪酬",
		avg:'',
		high:'',
		low:''
	},
	methods:{
		...
		BJ:function(){
			 this.titles="<span class='glyphicon glyphicon-stats' ></span> 北京大数据薪酬"; 
			var that = this;
		...
		SH:function(){
			this.titles="<span class='glyphicon glyphicon-stats' ></span> 上海大数据薪酬";
			var that = this;
		...
		SZ:function(){
			this.titles="<span class='glyphicon glyphicon-stats' ></span> 深圳大数据薪酬";
			var that = this;
		...
		HZ:function(){
			this.titles="<span class='glyphicon glyphicon-stats' ></span> 杭州大数据薪酬";
			var that = this;
		...
		GZ:function(){
			this.titles="<span class='glyphicon glyphicon-stats' ></span> 广州大数据薪酬";
			var that = this;
		...
		CD:function(){
			this.titles="<span class='glyphicon glyphicon-stats' ></span> 成都大数据薪酬";
			var that = this;
		...
		WH:function(){
			this.titles="<span class='glyphicon glyphicon-stats' ></span> 武汉大数据薪酬";
			var that = this;
		...
		NJ:function(){
			this.titles="<span class='glyphicon glyphicon-stats' ></span> 南京大数据薪酬";
			var that = this;
